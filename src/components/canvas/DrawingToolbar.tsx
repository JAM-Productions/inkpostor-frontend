...
export const DrawingToolbar: React.FC<DrawingToolbarProps> = ({
  ...
  const undoButton = (
    <button
      type="button"
      onClick={onUndo}
      className="size-10 rounded-xl shrink-0 cursor-pointer bg-stone-700 flex items-center justify-center text-stone-300 hover:bg-stone-600 transition-colors active:scale-95"
      title={t("canvas.undo")}
