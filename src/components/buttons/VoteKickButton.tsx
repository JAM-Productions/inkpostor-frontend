...
export const VoteKickButton: React.FC<VoteKickButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`flex shrink-0 items-center justify-center rounded-[12px_4px_14px_4px] border-2 border-stone-950 transition-all cursor-pointer px-2 py-1 gap-1.5 shadow-[2px_2px_0px_#000] hover:-rotate-3 active:translate-x-0.5 active:translate-y-0.5 ${
        hasVoted
