...
export const ImpostorFinalGuess: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-stone-950 p-4">
      <div className="w-full max-w-md space-y-6 rounded-3xl border-2 border-purple-500/40 bg-stone-900/70 p-8 text-center shadow-[0_0_50px_rgba(168,85,247,0.2)] animate-fade-in">
        ...
        <button
          ...
          className="w-full rounded-xl border border-stone-600 bg-stone-800 px-4 py-2.5 font-bold text-stone-300 transition-[background-color,transform] hover:bg-stone-700 hover:text-white active:scale-95 cursor-pointer"
        >
