...
test.describe("High-Value Production Test: Host Drop Recovery", () => {
  test("Abrupt host tab closure mid-drawing phase seamlessly advances turn to Player 2 without hanging", async ({
    browser,
  }) => {
    ...
    await expect(pageHost.locator("body")).toContainText("P3HostDrop", {
      timeout: 15000,
    });
