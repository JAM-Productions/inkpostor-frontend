  ...
  return (
    <div className="flex gap-3">
      ...
      <button
        ...
        className="flex shrink-0 items-center justify-center gap-2 rounded-[14px_4px_16px_5px] border-2 border-stone-950 bg-[#181512] px-4 py-3 font-handwritten text-lg font-bold text-amber-200 hover:bg-stone-800 transition-colors transition-transform hover:-rotate-1 active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_#0c0b09] shadow-[3px_3px_0px_#0c0b09] cursor-pointer"
      >
