...
export const ImpostorFinalGuess: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-ink-bg px-4 pt-16 pb-8 sm:px-6 sm:pt-20 md:pt-24 relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-md sm:max-w-xl space-y-5 sm:space-y-6 rounded-[255px_15px_225px_15px/15px_225px_15px_255px] border-3 border-stone-950 bg-ink-surface p-6 sm:p-8 text-center shadow-[6px_6px_0px_#0c0b09] animate-fade-in relative">
        {/* Taped corner accent */}
        ...
        <CanvasSnapshot heightClass="h-[27vh]" />
