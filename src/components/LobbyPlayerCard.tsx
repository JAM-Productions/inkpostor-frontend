          ...
          {isPendingKick ? (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex size-8 items-center justify-center rounded-full border border-red-500/40 bg-red-500/10 text-white transition-colors hover:bg-red-500/20 cursor-pointer"
            ...
            <button
              ...
              className="group relative inline-flex size-8 items-center justify-center rounded-full border border-stone-600 bg-stone-800 text-white transition-colors hover:border-red-500/40 hover:bg-red-500/10 hover:text-white cursor-pointer"
